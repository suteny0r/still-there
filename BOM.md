...
| 6 | 1 (pack of 14) | Amabro USB-C panel-mount female socket breakout, 20.1 x 6.75 mm board, V/GND/D+/D-/CC pads, two mounting holes 16 mm apart | power inlet: screws flat to the internal pad on the base's back (+X) wall with two M2x4 self-tapping screws (item 2), receptacle through the 10 x 4.2 slot. Solder the 5 V and GND wires to the V and GND pads; only those two are needed | [B0H9S9C73Q](https://www.amazon.com/Amabro-Connector-Female-Socket-Breakout/dp/B0H9S9C73Q) |
