...
| 2 | M2x8: 2 base lid, 2 head lid; M2x6: 2 head-to-single-arm horn (an 8 would reach the servo boss), 2 disc-to-double-arm horn; M2x4: 2 inlet board (servo ear screws come with the servos) | M2 flat-head self-tapping screw assortment, 800 pcs, 4 to 20 mm | every M2 pilot in the design is 1.75 mm for self-tapping M2 | [B0CY986CCR](https://www.amazon.com/Tapping-Woodworking-Fastener-Drilling-Assortment/dp/B0CY986CCR) |
| 3 | 1 | M3 x 8 button-head Torx screw, stainless | tilt pivot through arm B into the head; the 1.6 mm countersink in the arm is sized for a button head (5.7 dia x 1.65). 8 mm ends 0.35 mm short of the head cavity; a 12 mm would run 3.6 mm in and hit the XIAO edge | [B0GS115MXJ](https://www.amazon.com/dp/B0GS115MXJ) (the 12 mm version [B0GRZK17TZ](https://www.amazon.com/dp/B0GRZK17TZ) is too long for this design) |
...
| 6 | 1 (pack of 14) | Amabro USB-C panel-mount female socket breakout, 20.1 x 6.75 mm board, V/GND/D+/D-/CC pads, two mounting holes 16 mm apart | power inlet: screws to the flat facet on the OUTSIDE of the base's back (+X) wall with two M2x4 self-tapping screws (item 2), connector body through the 13 mm slot, board face flush with the wall so a plug reaches. Solder the 5 V and GND wires to the V and GND pads; only those two are needed | [B0H9S9C73Q](https://www.amazon.com/Amabro-Connector-Female-Socket-Breakout/dp/B0H9S9C73Q) |
...
| 9 | 1 (pack of 10), optional | 650 nm 5 V 5 mW red dot laser module, 6 mm brass barrel (HiLetgo) | "fire" indicator in the saddle on top of the head; fixed focus, ~20 mA at 5 V. Class 3R: not for pointing at faces. 6 mm barrel: set `laser_d = 6.3` before printing the head (default is 7.3 for item 9c) | [B071FT9HSV](https://www.amazon.com/HiLetgo-10pcs-650nm-Diode-Laser/dp/B071FT9HSV) |
...
| 9c | 1, optional | Quarton VLM-650-03 LPT, Class 2 <1 mW, APC driver, 2.6 to 6 V, 7 x 21 mm | the quality option (regulated driver, made in Taiwan); 7 mm barrel. The head is printed for this module (`laser_d = 7.3` default since 2026-09-19) | [B00ZR80S9S](https://us.amazon.com/Quarton-Laser-Module-VLM-650-03-ECONOMICAL/dp/B00ZR80S9S) |
